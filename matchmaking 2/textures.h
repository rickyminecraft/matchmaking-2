...
public:
	...
	sf::Texture * Get_tuile(short Number);
	sf::Texture * Get_fond(short Number);
	sf::Texture * Get_exit();
	sf::Texture * Get_play();
	...
	//pour les particules
	sf::Image Get_Image(short Number);
...
private:
	...
	sf::String Selection_name = "selection.png";
	sf::String Tuile_back_name = "tuile_back.png";
